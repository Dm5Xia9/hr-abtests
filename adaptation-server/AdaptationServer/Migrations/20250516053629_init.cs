        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    MeetingUrl = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Participants = table.Column<List<string>>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyMembers_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTracks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeTracks_AspNetUsers_MentorId",
                        column: x => x.MentorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_EmployeeTracks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeTracks_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyMembers_PositionId",
                table: "CompanyMembers",
                column: "PositionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTracks_MentorId",
                table: "EmployeeTracks",
                column: "MentorId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTracks_TrackId",
                table: "EmployeeTracks",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTracks_UserId",
                table: "EmployeeTracks",
                column: "UserId");
